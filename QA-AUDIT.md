...
| 6 | [approach-private-identity.md](approaches/approach-private-identity.md) | `ok` | Meyanis95 | 2026-06-24 | 2026-06-24 | TACEO OPRF → `live in production` (CR follow-up 2026-06-29 superseded the earlier `public beta` fix; approach maturity stays `prototyped`); removed dangling `A-E`/`A-D` letter refs; ZKPassport 120+ countries & Aztec-sale OFAC/Swiss/EU/UK claims verified (stand); status→ready |
