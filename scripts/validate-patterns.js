...
/**
 * Validate v2-specific frontmatter fields. Strict mode: these are errors.
 */
function validateV2Fields(frontmatter, fileErrors) {
  ...
  if (frontmatter.type === 'meta') {
    ...
    fileErrors.push(`sub_patterns is populated but type is not 'meta'. Remove sub_patterns or set type: meta.`);
  }
