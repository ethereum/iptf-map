...
- **Post-quantum exposure**: pairing-based threshold encryption (DKG) is broken by CRQC; pre-inclusion ciphertext has HNDL risk. Mitigation: lattice-based threshold encryption. See [Post-Quantum Threats](../domains/post-quantum.md).
