...
- **Post-quantum exposure**: threshold ECDSA/EdDSA is broken by CRQC (not HNDL-urgent — signatures are public). Mitigation: ML-DSA or hash-based threshold schemes. See [Post-Quantum Threats](../domains/post-quantum.md).
