...
See [**Approach: Private Identity — Issuer-Independent Enrollment**](../approaches/approach-private-identity.md#issuer-independent-enrollment-via-distributed-oprf) for detailed architecture and trade-offs.
