...
- feat(pattern): [Immutable Guarantees](patterns/pattern-immutable-guarantees.md) -- separating mutable operational parameters from immutable safety invariants, with a published invariant set that survives hostile operators ([#127](https://github.com/ethereum/iptf-map/issues/127))
